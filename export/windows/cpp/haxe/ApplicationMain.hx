...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "DateSim", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "DateSim";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "DateSim", null, { width: 1280, height: 720 });
