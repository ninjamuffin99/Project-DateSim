...
HXLINE( 272)				EndIndex = (Objects->length - (int)1);
            			}
HXLINE( 275)			 ::Dynamic Max = (Objects->length - (int)1);
...
HXDLIN( 276)			 ::Dynamic Max1 = (Objects->length - (int)1);
...
HXLINE( 292)			selected = Objects->__get(this->weightedPick(::flixel::math::FlxRandom_obj::_arrayFloatHelper)).StaticCast<  ::flixel::_hx_system::FlxSound >();
            		}
...
static ::String FlxRandom_obj_sMemberFields[] = {
	HX_HCSTRING("getObject_flixel_system_FlxSound","\xd4","\xf4","\x55","\x36"),
