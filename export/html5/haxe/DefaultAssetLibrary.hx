...
@:keep @:bind #if display private #end class __ASSET__assets_images_electron_particle_v1_zip extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_images_electron_particle_v2_zip extends null { }
